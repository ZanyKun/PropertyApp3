              ...
              <%
				  ...
				  if(user == null){
						out.print("<div class='aa-header-right' style='display:block'>" +
				                  ...
				                  "<a href='/login' class='aa-login'>Login</a> </div>");
				  }else{
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul id="top-menu" class="nav navbar-nav navbar-right aa-main-nav">
            ...
            <li><a href="/listing">LIST PROPERTY</a></li>    
            ...
            <div class="row">
              <div class="col-md-4">
              	<div class="aa-single-advance-search">
              		<div class="ui-widget">
	              		<input id="autoSearch" type="text" name="keyword" style="font-size:14px" placeholder="Search by Project Name, Location or Keyword" 
	              		title="Keyword required for searching" onkeydown="myFunction()" required/>
              		</div>
              	</div>
              </div>
              <div class="col-md-2">
